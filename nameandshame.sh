...
#tip jar
#Bitcoin Cash (BCH)  
#qpz32c4lg7x7lnk9jg6qg7s4uavdce89myax5v5nuk
#Ether (ETH)		    
#0x843d3DEC2A4705BD4f45F674F641cE2D0022c9FB
#Litecoin (LTC)			  
#Lfk5y4F7KZa9oRxpazETwjQnHszEPvqPvu
#Bitcoin (BTC)			    
#14Dm7L3ABPtumPDcj3REAvs4L6w9YFRnHK
...
grep -E -o "([0-9]{1,3}[\.]){3}[0-9]{1,3}" host.txt > tmphost.txt
mv tmphost.txt host.txt
...
do
    ...
    temp="ssh brute force: "$IP
    tweet="$temp #threatintel #malware #cybersecurity #infosec #BlueKeep #cybercrime #botnet #OSINT"
    echo -e "$tweet"
